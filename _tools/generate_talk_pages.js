  ...
  for(let i = 0; i < shortnames.length; i++) {
    ...
    for (let [lang, suffix] of Object.entries(languages)) {
      ...
      if (talk.video) {
        ...
        sectionContent[lang] += `<details class=talk><summary><div class="grid"><a href="talks/${slug}.html"><img src="${talk.thumbnail}" alt="Watch ${talk.title}" width=200 class="tn"></a><a href="talks/${slug}.html">${talk.title}</a><span class="summary"> by ${talk.author}${talk.affiliation ? " (" + talk.affiliation + ")" : ""} - ${duration} min <span></span></span></div></summary>`;
